...
![Add CatVision.io SDK dependency via Android Studio]({{site.url}}/catvision/assets/images/cvio_android_studio_dependencies.png)
...
![CatVision.io API Key ID is added to AndroidManifest.xml]({{site.url}}/catvision/assets/images/cvio_android_studio_manifest.png)
...
![Android Application connected to CatVision.io]({{site.url}}/catvision/assets/images/cvio_android_emulator_share.png)
