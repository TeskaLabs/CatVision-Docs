...
![Add CatVision.io SDK dependency via Android Studio]({{site.baseurl}}/catvision/assets/cvio_display_arch.png)
...
![CatVision.io Client Tag in a web app]({{site.baseurl}}/catvision/assets/cvio_client_tag_ap.png)
